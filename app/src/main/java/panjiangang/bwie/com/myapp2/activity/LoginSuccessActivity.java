...
import panjiangang.bwie.com.myapp2.presenter.MainPresenter;


public class LoginSuccessActivity extends Activity implements MainPresenter.Preinterface {
    ...
    @OnClick({R.id.xiala, R.id.dai, R.id.zhifu, R.id.quxiao, R.id.dai1, R.id.zhifu1, R.id.quxiao1})
