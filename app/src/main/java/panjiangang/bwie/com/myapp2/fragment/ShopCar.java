...
import panjiangang.bwie.com.myapp2.CountView;
import panjiangang.bwie.com.myapp2.R;
import panjiangang.bwie.com.myapp2.bean.ShopBean;
...
public class ShopCar extends Fragment {
    ...
    boolean allck = false;
    private ShopCar.rvAdapter rvAdapter;//适配器

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_fragment_shopcar, null);
        qx_img = view.findViewById(R.id.qx_img);
        jsBtn = view.findViewById(R.id.js_btn);
        geshu = view.findViewById(R.id.geshu);
        ...
        qx_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (allck) { //判断   是否是全选中状态
                    ...
                    qx_img.setBackgroundResource(R.drawable.shopcart_selected);
                    ...
                    qx_img.setBackgroundResource(R.drawable.shopcart_unselected);
                    for (int i = 0; i < data.size(); i++) {
    ...
    private void gethttp() {
        ...
        Request request = new Request.Builder().url("http://120.27.23.105/product/getCarts?uid=100&source=android").build();
